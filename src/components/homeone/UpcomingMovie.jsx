        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="tr-movie-menu2-active text-center">
              <button className="active" data-filter="*" onClick={() => setItems(Menu)}>Анхлан суралцагч</button>
              <button data-filter=".cat-two" onClick={() => filterItem('documentary')}>Тамирчин</button>
              <button data-filter=".cat-one" onClick={() => filterItem('Movies')}>Мэргэжлийн тамирчин</button>
              <button data-filter=".cat-three" onClick={() => filterItem('sports')}>Дасгалжуулагч</button>
            </div>
          </div>
        </div>
